  ...
  uplinks: {
    ...
    steps: [
      ...
      { title: 'A GOAL COMES FROM A DREAM', titleRu: 'ЦЕЛЬ РОЖДАЕТСЯ ИЗ МЕЧТЫ',
        body: 'You do not create one here. Write a dream on the DREAMS tab and promote it — the guide proposes a chain of routines and you edit every node before a single habit exists.',
        bodyRu: 'Здесь его не создают. Запишите мечту на вкладке МЕЧТЫ и продвиньте её — гид предложит цепь рутин, а вы правите каждый узел до появления первой привычки.' },
    ],
  },
